  ...
  return (
    <>
      ...
      <DarkPanel className="p-4 space-y-4">
        ...
        <div className="flex gap-2">
          ...
          >
            {isLocked ? (
              ...
              <>
                <svg viewBox="0 0 16 16" className="w-3 h-3" fill="currentColor">
                  <path d="M11 7V5a3 3 0 0 0-6 0v2H4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V8a1 1 0 0 0-1-1h-1zm-4-2a1 1 0 0 1 2 0v2H7V5z" opacity="0.5" />
                </svg>
                Lock Room
              </>
            )}
        ...
        {isLocked && (
          <p className="text-amber-700/60 text-[10px] text-center italic">

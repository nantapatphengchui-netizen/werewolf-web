...
const PHASE_THEME: Partial<Record<GamePhase, PhaseTheme>> = {
  night: {
    label: 'NIGHT',
    subtitle: 'Everyone closes their eyes.\nNight actions are in progress.',
    labelClass: 'text-violet-200',
    subtitleClass: 'text-violet-900/90',
  ...
  day: {
    label: 'DAY',
    subtitle: 'The village wakes. Discuss, debate, and find the wolf.',
    labelClass: 'text-amber-200',
    subtitleClass: 'text-amber-800/80',
  ...
  voting: {
    label: 'VOTE',
    subtitle: 'The village must decide. Cast your vote.',
    labelClass: 'text-red-300',
    subtitleClass: 'text-red-900/80',
